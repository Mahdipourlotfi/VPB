  ...
  <div id="app">
    ...
    <div id="draggable" class="ui-widget-content ">
      <div class="circle">
        ...
        <div class="center fa fa-th fa-2x" data-icon=" fa-th "></div>
      </div>
    </div>
    {{--circle menu end --}}
...
rex.hide_items();
$("div.menuItem:not(.center,.close)").click(function(e) {  
  let icon=$(this).attr("data-icon");
  let centerelement=$("div.center");
  centerelement.switchClass( centerelement.attr("data-icon"), icon );
  centerelement.attr("data-icon",icon);
  //$(".ring a ,.ring div").hide();
  rex.hide_items();
  let items = $(this).find ("a,div" );
...
$('.center').click ( function(e) {
  ...
  if( dragging==false)
{
 if(rex.currentdiv.attr('class')!='ring')
 rex.returnback();
else
